...
# Jaehee_theme
Jaehee_theme <- function(){
  theme(legend.spacing.x = unit(0.1, "mm"),
...
# art_boxplot -------------------------------------------------------------
art_boxplot <- use_this_data %>%
  ggplot(aes(x = prob_art, y = as.factor(topics), fill=as.factor(topics))) +
...
# biology_boxplot ---------------------------------------------------------
biology_boxplot <- use_this_data %>% 
  ggplot(aes(x = prob_biology, y = as.factor(topics), fill=as.factor(topics))) + 
  geom_boxplot(alpha=0.5) + 
  coord_flip()+
  Jaehee_theme() + 
  scale_fill_brewer(palette="Dark2") + 
...
# politics_boxplot ---------------------------------------------------------
politics_boxplot <- use_this_data %>% 
  ggplot(aes(x = prob_politics, y = as.factor(topics), fill=as.factor(topics))) + 
  geom_boxplot(alpha=0.5) + 
  coord_flip() +
  Jaehee_theme() + 
  scale_fill_brewer(palette="Dark2") + 
...
# cookery_boxplot ---------------------------------------------------------
cookery_boxplot <- use_this_data %>% 
  ggplot(aes(x = prob_cookery, y = as.factor(topics), fill=as.factor(topics))) + 
  geom_boxplot(alpha=0.5) + 
  coord_flip() +
  Jaehee_theme() + 
  scale_fill_brewer(palette="Dark2") + 
...
# travel_boxplot ---------------------------------------------------------
travel_boxplot <- use_this_data %>% 
  ggplot(aes(x = prob_travel, y = as.factor(topics), fill=as.factor(topics))) + 
  geom_boxplot(alpha=0.5) + 
  coord_flip() +
  Jaehee_theme() + 
  scale_fill_brewer(palette="Dark2") + 
...
ggpubr::ggarrange(art_boxplot, biology_boxplot, politics_boxplot, cookery_boxplot, travel_boxplot, 
          ncol = 3, nrow = 2)
